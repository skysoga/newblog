...
function getPopperOffsets(popper, referenceOffsets, placement) {
  ...
  popperOffsets[mainSide] = referenceOffsets[mainSide] + referenceOffsets[measurement] - popperRect[measurement];
  if (placement === secondarySide) {
    popperOffsets[secondarySide] = referenceOffsets[secondarySide] - popperRect[secondaryMeasurement] + 2;
    console.log('popperOffsets', popperOffsets, popperOffsets[secondarySide])
  } else {
    popperOffsets[secondarySide] = referenceOffsets[getOppositePlacement(secondarySide)];
    console.log('popperOffsets1', popperOffsets, popperOffsets[secondarySide])
  }
